...
<head>
    ...
    <!-----TITLE---->
    <title>Usuario-<?php echo ucfirst($_SESSION['usuario']).'.';?></title>
    <!-------FONTS------>
        ...
        <nav class="navbar navbar-expand-lg   fixed-top" id="Navbar">
            ...
            <div class="collapse navbar-collapse " id="navbarNav">
                <ul class="navbar-nav ml-3 ">
                    ...
                    <li class="nav-item efect">
                        <a class="nav-link text-white mt-3" data-toggle="modal" data-target="#ModalLogin" href="#"><i class="fas fa-sign-in-alt mr-2"></i>Sair</a>
                    </li>
                </ul>
            </div>
        </nav>
