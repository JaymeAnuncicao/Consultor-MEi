            ...
            <div class=" row black-bj">
                ...
                <div class="row container-fluid justify-content-center mt-5" id="fun1">
                    ...
                    <div class="row container text-justify">
                        <p class="text-white mov1">O Consultor MEi, é uma Plataforma Web, do grupo Maximo’s Tecnologia.
                            ...
                            Com uma ferramenta ampla e moderna estamos podendo oferecer consultoria a qualquer MEI (Micro empreendedor individual) ou ME (Micro empresário) do território brasileiro, pois todos merecem a oportunidade de ter apoio quando precisa.</p>
                    </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mt-5 mb-5 container-fluid pl-5">
                    <div class="col-md-10 col-sm-4">
                            ...
                            <hr noshade class="func30">
                            <div class="row container justify-content-center text-justify">
                                <div class="col-md-6">
                ...
                <div class="row justify-content-center mt-5 mb-5 container-fluid pl-5">
                    <div class="col-md-6 col-sm-4">
                        <div class="row container justify-content-center"><h4 class="text-white">O cartão MEi</h4></div>
                        <hr noshade class="func31">
                        <div class="row container text-justify">
                            <div class="row justify-content-center text-justify">
                                <p class="text-white">Olhe que legal os MEI’s e os ME’s são mais ou menos 8.000.000 (oito milhões) de empresas. Que tal você dar um desconto em seu serviço ou produto para esses MEI’s e ME’s e que tal também esses MEI’s e ME’s datem um desconto pra você que é associado ao Consultor Mei.</p>
                                <p class="text-white text-left"><strong>1 – </strong>Você se cadastra no Consultor Mei</p>
                                <p class="text-white"><strong>2 – </strong>Você recebe um email do consultor mei. No email vão dois arquivos em PDF para você imprimir</p>
                                <p class="text-white">- o primeiro é um cartão MEI, com os dados de sua empresa e o nome do responsável , além do seu numero de cadastro.</p>
                                <p class="text-white">- o segundo é um folheto em A4 (tamanho de uma folha de papel), nele também tem os dados da empresa e seu numero de cadastro, nele você terá um local para informar o percentual que você vai dar de desconto e o produto que terá o desconto.Você pode dar descontos diferenciados a mais de um produto ou serviço.</p>
                                <p class="text-white"><strong>3 – </strong>Você responde ao email dizendo quais os produtos ou serviços você vai dar desconto e como as pessoas poderão lhe encontrar (local, telefone etc).Obs. O produto ou serviço tem que ter ligação com o seu CNPJ</p>
                                <p class="text-white"><strong>4 – </strong>Nos do Consultor mei publicaremos em nosso site todas as empresas que estarão dando descontos, e enviaremos aos mei’s e ME’s das suas regiões que estejam cadastrados em nossa plataforma, para que eles possam usufruir dos seus descontos.</p>
                                <p class="text-white"><strong>5 – </strong>Você deve cadastrar descontos dados ou recebidos na plataforma , <a href="#">www.consultormei.com.br/cartaomei </a>. usando o código de cadastro do cliente, se fizer isso concorrerá a prêmios tais como:</p>
                                <p class="text-white mr-5">- Ebooks <br>- Consultoria de 6 meses em um seguimento</p>
                            </div>
