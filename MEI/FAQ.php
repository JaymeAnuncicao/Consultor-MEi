    ...
    <div class="modal fade" id="ModalCadastro" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document"> 
            <div class="modal-content">
                ...
                <form class="text-center primary-color-dark p-5" name="form1" method="post" action="PHP/login.php">                  
    ...
    <div class="modal fade bd-example-modal-sm" id="ModalLogin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-login">
                ...
                <form class="text-center primary-color-dark p-5" method="post" action="PHP/login.php">
